...
function parseOptions (options) {
  ...
  if (compression != null) {
    ...
    if (compression === 'NONE' || compression === 'UDZO' || compression === 'UDBZ') {
...
module.exports = exports = function (options) {
  ...
  pipeline.addStep('Validating JSON Specification', function (next) {
    ...
    var contents = (global.opts.contents || [])
    contents.forEach(function (entry, i) {
  ...
  pipeline.addStep('Finalizing image', function (next) {
    hdiutil.convert(global.temporaryImagePath, global.compression || 'UDZO', global.target, next)
  })
